...
| **22. Biological Harmony Prior & Manipulation Gate** | Resilient evidence gating (prevents authenticity bonuses whenever neural backbone detects manipulation) to detect high-level reanimated deepfakes | [`webapp/model_service.py`](file:///d:/Documents/Programming/Thesis_G10/webapp/model_service.py#L412-L435) | `harmony_bonus` |
