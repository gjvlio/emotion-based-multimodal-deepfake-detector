...
def main():
    ...
    parser.add_argument("--n_adapt_real", type=int, default=150)
    parser.add_argument("--n_adapt_fake", type=int, default=150)
    parser.add_argument("--n_test_real", type=int, default=350)
    parser.add_argument("--n_test_fake", type=int, default=350)
